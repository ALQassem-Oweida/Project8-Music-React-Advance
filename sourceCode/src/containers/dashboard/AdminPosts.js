...
const AdminPosts = () => {
    ...
    const setApproval = (id,n,message) => {
        axios.put(`http://localhost/ApiReduxPro8/Adminpost.php`, {post_id:id,approval:n}).then(function (response) {
            console.log(response.data);
            getUse();
        });
        getUse();
                                ...
                                <tbody>{currentComments.map((post, key) =>
                                    ...
                                    <tr key={key}>
                                        ...
                                        <td scope="col-2">
                                            ...
                                            <button type="submit" onClick={()=>setApproval(post.id,0,'Post Unapproved')} className="btn btn-danger"  >
